...
<body>
	<ul class="header">
		...
		<li class="active-header-menu-item"><a href="addCompany"
	...
	<div>
		<div>
			<p>Please, add the company.</p>
		</div>
		<form action="addCompany" method="post">
			<fieldset class="add-form">
				<div class="field">
					<label for="name">Name</label> <input type="text" id="company"
						name="company" placeholder="write name of your company" required>
				</div>

				<div class="field">
					<label for="earnings">Earnings</label> <input type="text"
						id="earnings" name="earnings" placeholder="100K" required>
				</div>
