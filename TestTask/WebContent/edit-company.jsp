				...
				<div class="field">
					...
					<select id="parent" name="parent">
						...
						<c:forEach items="${companies}" var="nextCompany">
							<option value="${nextCompany.id}">${nextCompany.id} ${nextCompany.name} </option>
						</c:forEach>
					</select>
					
					<p><label for="name">Company's name</label>
					<input type="text" id="company" name="company" value="${company.name}"></p>
					
					<p><label for="earnings">Earnings</label>
					<input type="text" id="earnings" name="earnings" value="${company.earnings}"></p>
